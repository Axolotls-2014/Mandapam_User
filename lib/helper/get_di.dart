...
import 'package:sixam_mart/features/details/domain/repositories/details_repository.dart';
import 'package:sixam_mart/features/details/domain/repositories/details_repository_interface.dart';
import 'package:sixam_mart/features/details/domain/services/details_service.dart';
...
import 'package:sixam_mart/features/nearby/domain/repositories/decorator_repository.dart';
...
import 'package:sixam_mart/features/nearby/domain/services/decorator_services.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  DetailsRepositoryInterface detailsRepositoryInterface =
      DetailsRepository(apiClient: Get.find(), sharedPreferences: Get.find());
  Get.lazyPut(() => detailsRepositoryInterface);
  DecoratorRepositoryInterface decoratorRepositoryInterface =
      DecoratorRepository(apiClient: Get.find(), sharedPreferences: Get.find());
  Get.lazyPut(() => decoratorRepositoryInterface);
  ...
  Get.lazyPut(() => advertisementServiceInterface);
   ...
   DetailsServiceInterface detailsServiceInterface =
      DetailsService(detailsRepositoryInterface: Get.find());
  Get.lazyPut(() => detailsServiceInterface);
   DecoratorServiceInterface decoratorServiceInterface =
      DecoratorServices(decoratorRepositoryInterface: Get.find());
  Get.lazyPut(() => decoratorServiceInterface);
  ...
  Get.lazyPut(() => DetailsController(detailsServiceInterface: Get.find()));
  Get.lazyPut(() => DecoratorController(decoratorServiceInterface: Get.find()));
