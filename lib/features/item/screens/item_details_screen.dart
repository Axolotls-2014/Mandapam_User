          ...
          return GetBuilder<ItemController>(
            builder: (itemController) {
              ...
              return Scaffold(
                  ...
                  body: SafeArea(child:
                  // (itemController.item != null) ? ResponsiveHelper.isDesktop(context) ? DetailsWebViewWidget(
                  ...
                  Column(children: [
                    Expanded(child: SingleChildScrollView(
                        ...
                        child: Center(child: SizedBox(
                            width: Dimensions.webMaxWidth, child: Column(
                          ...
                          children: [
                            ...
                            (widget.item!.title != null &&
                                widget.item!.title!.isNotEmpty) ? Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                Wrap(children: List.generate(
                                    widget.item!.title!.length, (index) {
                                  return Text(
                                    '${widget.item!.title![index]}${widget.item!
