    ...
    return ResponsiveHelper.isDesktop(context) ? GetBuilder<ItemController>(builder: (itemController){
      return Column(
        ...
        children: [
          ...
          (itemController.item!.title != null && itemController.item!.title!.isNotEmpty) ? Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Wrap(children: List.generate(itemController.item!.title!.length, (index) {
                return Text(
                  '${itemController.item!.title![index]}${itemController.item!.title!.length-1 == index ? '.' : ', '}',
      ...
      child: GetBuilder<ItemController>(
        builder: (itemController) {
          return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            (item!.title != null && item!.title!.isNotEmpty) ? Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Wrap(children: List.generate(item!.title!.length, (index) {
                  return Text(
                    '${item!.title![index]}${item!.title!.length-1 == index ? '.' : ', '}',
                    style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withOpacity(0.5)),
                  );
                })),
