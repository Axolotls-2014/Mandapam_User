...
class CategoryRepository implements CategoryRepositoryInterface {
  ...
  Future getList({
    ...
    if (categoryList) {
      ...
      if (id == null) {
        throw ArgumentError('id cannot be null when subCategoryList is true');
      }
      return await _getSubCategoryList(id);
    } else if (categoryItemList) {

      if (id == null || offset == null || type == null) {
        throw ArgumentError('id, offset, and type cannot be null when categoryItemList is true');
      }
      return await _getCategoryItemList(id, offset, type);
    } else if (categoryStoreList) {
      if (id == null || offset == null || type == null) {
        throw ArgumentError('id, offset, and type cannot be null when categoryStoreList is true');
      }
      return await _getCategoryStoreList(id, offset, type);
    } else {
      throw ArgumentError('At least one of categoryList, subCategoryList, categoryItemList, or categoryStoreList must be true');
    }
  }
