...
import 'package:sixam_mart/features/nearby/widgets/decorator_card_with_distance.dart';
      ...
      length > 0
          ? GridView.builder(
              ...
              itemBuilder: (context, index) {
                // log("In ItemView::::Build");
                // log("widget.stores != null && widget.isStore::${widget.stores != null && widget.isStore}");
                // log("widget.isFoodOrGrocery! && widget.isStore::${widget.isFoodOrGrocery! && widget.isStore}");
                // log("widget.items::${widget.items}");
                return
                    // widget.stores != null && widget.isStore
                    // ?
                    // widget.isFoodOrGrocery! && widget.isStore
                    //     ? UserCardWidget(store: widget.stores![index])
                    //     :
                    DecoratorCardWithDistance(
                        store: widget.stores![index]!, fromAllStore: true);
                // : ItemWidget(
