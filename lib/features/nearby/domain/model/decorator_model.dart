...
DecoratorModel decoratorModelFromJson(Map<String, dynamic> json) => DecoratorModel.fromJson(json);

String decoratorModelToJson(DecoratorModel data) => json.encode(data.toJson());
...
class User {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "storage": storage == null ? [] : List<dynamic>.from(storage!.map((x) => x)),
    };
}
