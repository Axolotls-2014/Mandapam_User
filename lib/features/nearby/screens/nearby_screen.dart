...
class NearbyDecoratorsListState extends State<NearbyDecoratorsList> {
  ...
  void initState() {
    super.initState();
    // ✅ Fetch API only once when widget is created
  ...
  bool _matchesSearchQuery(dynamic user) {
    if (widget.searchQuery.isEmpty) return true;
    final String fullName = '${user.fName} ${user.lName}'.toLowerCase();
    final String address = (user.address ?? '').toLowerCase();
    final String query = widget.searchQuery.toLowerCase();
    return fullName.contains(query) || address.contains(query);
  }
